...
VERSIONS: List[Version] = [
    ...
    Version(major=12, minor=7, build=(0, 6)),
    ...
    Version(major=13, minor=6, build=(0, 9)),
    Version(major=13, minor=7, build=(0, 8)),
    ...
    Version(major=14, minor=7, build=(0, 8)),
    Version(major=14, minor=8, build=(0, 7)),
    ...
    Version(major=15, minor=7, build=(0, 7)),
    Version(major=26, minor=0, build=(0, 1)),
    Version(major=26, minor=1, build=0),
    Version(major=26, minor=2, build=0),
    Version(major=26, minor=3, build=(0, 2)),
    Version(major=26, minor=4, build=(0, 1)),
    Version(major=26, minor=5, build=(0, 1)),
]
