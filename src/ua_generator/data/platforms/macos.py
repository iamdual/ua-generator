...
versions: List[Version] = [
    ...
    Version(major=13, minor=7, build=(0, 6)),
    ...
    Version(major=14, minor=7, build=(0, 6)),
    ...
    Version(major=13, minor=7, build=(0, 7)),
    Version(major=14, minor=7, build=(0, 7)),
    Version(major=15, minor=6, build=0),
]
